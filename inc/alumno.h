 ...
 * @return alumno_t Puntero a la estructura creada, o NULL si no se pudo asignar memoria.
 */
 ...
 * @return int Longitud de la cadena generada, o -1 si el espacio es insuficiente.
 */
